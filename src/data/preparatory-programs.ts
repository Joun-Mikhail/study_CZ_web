...
export const universityPrograms: PrepProgram[] = [
  {
    ...
    language: "czech",
    programs: [
      { name: { en: "Medicine & Pharmacy COMPLEX", ar: "طب وصيدلة COMPLEX" }, intensity: "35 hours per week", location: "Prague", priceCzk: 169000, priceEur: 7253 },
      { name: { en: "Natural Science COMPLEX", ar: "علوم طبيعية COMPLEX" }, intensity: "35 hours per week", location: "Prague", priceCzk: 169000, priceEur: 7253 },
      { name: { en: "Engineering & IT COMPLEX", ar: "هندسة وتقنية COMPLEX" }, intensity: "35 hours per week", location: "Poděbrady", priceCzk: 167000, priceEur: 7167 },
      { name: { en: "Economics & Business COMPLEX", ar: "اقتصاد وأعمال COMPLEX" }, intensity: "35 hours per week", location: "Poděbrady", priceCzk: 167000, priceEur: 7167 },
      { name: { en: "Humanities COMPLEX", ar: "علوم إنسانية COMPLEX" }, intensity: "35 hours per week", location: "Prague", priceCzk: 167000, priceEur: 7167 },
      { name: { en: "Arts & Architecture COMPLEX", ar: "فنون وعمارة COMPLEX" }, intensity: "35 hours per week", location: "Prague", priceCzk: 167000, priceEur: 7167 },
      { name: { en: "Medicine & Pharmacy PROGRESS", ar: "طب وصيدلة PROGRESS" }, intensity: "25 hours per week", location: "Prague", priceCzk: 122000, priceEur: 5236 },
      { name: { en: "Natural Science PROGRESS", ar: "علوم طبيعية PROGRESS" }, intensity: "25 hours per week", location: "Prague", priceCzk: 122000, priceEur: 5236 },
      { name: { en: "Humanities PROGRESS", ar: "علوم إنسانية PROGRESS" }, intensity: "25 hours per week", location: "Prague", priceCzk: 120000, priceEur: 5150 },
      { name: { en: "Arts & Architecture PROGRESS", ar: "فنون وعمارة PROGRESS" }, intensity: "25 hours per week", location: "Prague", priceCzk: 120000, priceEur: 5150 },
    ],
  ...
  },
  {
    ...
    language: "english",
    programs: [
      { name: { en: "Medicine & Pharmacy in English COMPLEX", ar: "طب وصيدلة بالإنجليزية COMPLEX" }, intensity: "35 hours per week", start: "September", location: "Poděbrady", priceCzk: 182000, priceEur: 7811 },
      { name: { en: "Medicine & Pharmacy in English FAST", ar: "طب وصيدلة بالإنجليزية FAST" }, intensity: "25 hours per week", start: "November", location: "Prague", priceCzk: 115000, priceEur: 4936 },
      { name: { en: "Engineering & IT in English FAST", ar: "هندسة وتقنية بالإنجليزية FAST" }, intensity: "25 hours per week", start: "November", location: "Poděbrady", priceCzk: 113000, priceEur: 4850 },
      { name: { en: "Economics & Global Affairs in English FAST", ar: "اقتصاد وعلاقات دولية بالإنجليزية FAST" }, intensity: "25 hours per week", start: "November", location: "Poděbrady", priceCzk: 113000, priceEur: 4850 },
    ],
    contact: { email: "studujop@ujop.cuni.cz", phone: "+420 778 754 481" },
    website: { url: "https://ujop.cuni.cz/UJOPEN-1.html", label: "ujop.cuni.cz" },
  },
  {
    ...
    language: "czech",
    programs: [
      { name: { en: "INTENSIVE+", ar: "مكثف+" }, intensity: "20–25 hours per week", duration: "635 hours", priceCzk: null, priceEur: 4300 },
      { name: { en: "INTENSIVE", ar: "مكثف" }, intensity: "20 hours per week", duration: "570 hours", priceCzk: null, priceEur: 3950 },
      { name: { en: "BASIC", ar: "أساسي" }, intensity: "15 hours per week", duration: "440 hours", priceCzk: null, priceEur: 2850 },
    ],
    ...
    note: { en: "Year-long language & professional preparation, accredited under §64b. Visa purpose: \"Study.\" Academic year 2026/27: Sep 14, 2026 – Jun 13, 2027. Dormitory: ~7,500 CZK per month.", ar: "سنة تحضيرية لغوية ومهنية، معتمدة. غرض الفيزا: \"دراسة\". العام 2026/27: 14 سبتمبر 2026 – 13 يونيو 2027. السكن: ~7,500 كرونة في الشهر." },
  },
  {
    id: "muni-cjv",
    ...
    language: "czech",
    programs: [
      { name: { en: "One-Year Intensive Czech Course", ar: "دورة تشيكي مكثفة لسنة كملة" }, intensity: "20 hours per week", duration: "670 hours (620 in-person + 50 e-learning)", priceCzk: null, priceEur: 3990 },
    ],
  ...
  },
  {
    ...
    language: "czech",
    programs: [
      { name: { en: "Two-Semester Intensive Czech Course", ar: "دورة تشيكي مكثفة لفصلين" }, intensity: "16 hours per week", duration: "560 teaching units", priceCzk: 60000, priceEur: 2400 },
    ],
    contact: { email: "prikrylovam@vutbr.cz" },
    website: { url: "https://www.lli.vutbr.cz/english", label: "lli.vutbr.cz" },
    note: { en: "Budget-friendly option. Price does NOT include accommodation. 50% advance payment; refund if visa refused. Registration deadline: June 30.", ar: "الخيار الأرخص. السعر مش شامل السكن. دفعة مقدمة 50%؛ ترجيع لو الفيزا اترفضت. آخر موعد للتسجيل: 30 يونيو." },
  },
  {
    id: "cvut",
    ...
    note: { en: "Academic year 2026/27: Sep 21, 2026 – Aug 31, 2027. 560 in-class sessions. Czech course fulfills \"Study\" visa purpose.", ar: "العام 2026/27: 21 سبتمبر 2026 – 31 أغسطس 2027. 560 حصة. الكورس التشيكي بيأهلك لفيزا \"دراسة\"." },
  },
  {
    id: "vse",
...
export const usefulLinks = [
  ...
  { label: { en: "Visa Information (Ministry of Interior)", ar: "معلومات الفيزا (وزارة الداخلية)" }, url: "https://ipc.gov.cz/en/" },
  { label: { en: "Visa Information (MFA)", ar: "معلومات الفيزا (وزارة الخارجية)" }, url: "https://mzv.gov.cz/jnp/en/information_for_aliens/long_stay_visa/study_long_term.html" },
