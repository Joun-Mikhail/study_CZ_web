...
const pathNames: Record<string, { en: string; ar: string }> = {
  ...
  considering: { en: "Considering Czechia", ar: "التفكير في تشيكيا" },
  choosing: { en: "Choosing a University", ar: "اختيار الجامعة" },
  documents: { en: "Documents", ar: "الأوراق" },
  visa: { en: "Visa & Interview", ar: "الفيزا والمقابلة" },
  arrived: { en: "Just Arrived", ar: "لسه واصل" },
