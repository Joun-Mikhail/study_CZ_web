  ...
  ar: [
    {
      ...
      blocks: [
        ...
        {
          heading: "6. بياناتك",
          body: "بنجمع بس البيانات اللي انت بتقدمها طوعا (مثلا الاسم، الإيميل، رقم واتساب للاستشارات). مش بنبيع أو نشارك بياناتك مع أطراف تالتة. تقييم الأهلية بيشتغل على جهازك بس.",
        },
        {
          heading: "7. تواصل",
